                    ...
                    foreach (var singleAttribute in singleAttributeList.Attributes)
                    {
                        ...
                        if (identifierText == "ControllerOfEntity")
                        {
                            ...
                            stringBuilder.AppendLine($"public async Task<Create{entityName}Model> Create{entityName}(Create{entityName}Model create{entityName}Model, CancellationToken cancellationToken," +
                                $"[FromServices] {entityName}Service {entityName}Service)");
                            stringBuilder.AppendLine("{");
                            stringBuilder.AppendLine($"return await {entityName}Service.Create{entityName}Async(create{entityName}Model, cancellationToken);");
                            stringBuilder.AppendLine("}");
