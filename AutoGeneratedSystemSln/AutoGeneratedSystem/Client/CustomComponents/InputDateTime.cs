...
namespace AutoGeneratedSystem.Client.CustomComponents
{
    /// <summary>
    /// Handles Dates with Time. Check https://github.com/dotnet/aspnetcore/issues/18078
    /// </summary>
    ...
    public class InputDateTime<TValue> : InputDate<TValue>
    {
        ...
        static bool TryParseDateTimeOffset(string value, out TValue result)
        {
            ...
            if (!success)
            {
                success = DateTimeOffset.TryParse(value, out parsedValue);
            }
            if (success)
            {
                result = (TValue)(object)parsedValue;
