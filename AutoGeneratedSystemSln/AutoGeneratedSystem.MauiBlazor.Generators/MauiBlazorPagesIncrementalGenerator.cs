...
{
    [Generator]
    public class MauiBlazorPagesIncrementalGenerator : IIncrementalGenerator
    {
    ...
    ImmutableArray<AdditionalText> additionalTexts, SourceProductionContext context)
            ...
            string entityName, string assemblyNameFirstPart)
        {
            ...
            pageCodeBehind.AppendLine($"namespace {assemblyNameFirstPart}.MauiBlazor.Pages.{entityName}");
            ...
            string assemblyNameFirstPart)
        {
            ...
            foreach (IPropertySymbol singleProperty in modelProperties)
            {
                razorPage.AppendLine($"@(nameof(single{entityName}.{singleProperty.Name}).Humanize().Titleize()):@single{entityName}.{singleProperty.Name} <br>");
            }
